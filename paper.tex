...
Unfortunately, this has not been the case. Over the past decade SIRC had seen it's budget remain flat, increasing from only \$2.9 to \$3 million, and it's employees shrink from 20 to 16. Worse, the incumbent government neglected to fill vacant seats within the committee over four years, leaving it with less members than intended. At the time, the current privacy commissioner warned against increasing surveillance powers without also increasing oversight. \cite{watchdog-starved}
